...
##
## As part of : 
##    Planque, Y., Spitz, J., Authier, M., Vincent, C., Caurant, F.
...
### I // Data #############################################################################################
  ## 1 / Direction 
  Direction <- ".../Script_Planque_et_al_Foraging_areas_V1_1"
  #Direction <- "C:/Users/yplanq01/Documents/CEBC/Article_Planque_et_al_Niche_Overlap/Scripts/Foraging_areas/Script_Planque_et_al_Foraging_areas_V1_1"
...
##
## >> The individual foraging areas presented in Planque et al. (in review) were identified using this
...
##
## >> The maps in Planque et al. (in review) were realised with ArcMap 10.6, using the exported shapefiles.
##
